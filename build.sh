...
# Author: Bruce-Lee-LY
# Date: 22:30:54 on Tue, May 17, 2022
#
...
echo "branch: $BRANCH" >> $WORK_PATH/output/tp_version
echo "commit: $COMMIT" >> $WORK_PATH/output/tp_version
echo "gcc_version: $GCC_VERSION" >> $WORK_PATH/output/tp_version
echo "compile_time: $COMPILE_TIME" >> $WORK_PATH/output/tp_version
